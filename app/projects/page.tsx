...
export default function Projects(){return <><section className="page-hero projects-hero"><div className="container"><p className="kicker light">Installation gallery</p><h1>Real Solar Work, Seen Up Close</h1><p>Explore rooftops, rural arrays, ground-mounted systems, equipment and installation progress without unsupported project statistics.</p></div></section><Breadcrumbs current="Projects"/><section className="section"><div className="wide-container"><SectionHeading kicker="Browse the gallery" title="Solar installations from multiple angles." text="Use the filters to focus on residential rooftops, agricultural settings, ground-mounts or installation details."/><ProjectGallery/></div></section><VideoShowcase/><FinalCTA/></>}
