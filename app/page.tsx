...
export default function Home() { return <>
  ...
  <SolarProcess/>
  <section className="solar-club-rates section"><div className="container"><SectionHeading kicker="Alberta solar rates" title="Rates that work with the way your system produces." text="A simple view of the pre-solar, low and high export-rate options available through Solar Club." align="center"/><div className="solar-rate-grid"><article className="solar-rate-card rate-pre"><p>Pre-solar rate</p><strong>5.90<small>¢/kWh</small></strong><span>For your transition period before the system is installed and producing.</span></article><article className="solar-rate-card rate-low"><p>LO rate <em>1 year</em></p><strong>5.90<small>¢/kWh</small></strong><span>Applies once an eligible micro-generation site is registered and switched to the LO rate.</span></article><article className="solar-rate-card rate-high"><p>HI rate</p><strong>35.00<small>¢/kWh</small></strong><span>Designed for members exporting excess solar electricity to the grid.</span></article></div><p className="solar-rate-note">Rates shown for reference. Retailer terms, eligibility and rate availability can change; confirm current details before enrolling.</p></div></section>
  <SolarPaymentOptions/>
  <PartnerNetwork/>
  ...
  <section className="section faq-section"><div className="container"><SectionHeading kicker="Common questions" title="Useful answers before you request a proposal." align="center"/><FAQList items={commonFaqs.slice(0, 9)} initiallyOpen={false}/></div></section>
  <FinalCTA/>
  </>; }
