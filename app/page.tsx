...
export default function Home() { return <>
  ...
  <section className="section faq-section"><div className="container"><SectionHeading kicker="Common questions" title="Useful answers before you request a proposal." align="center"/><FAQList items={commonFaqs.slice(0, 3)} initiallyOpen={false}/></div></section>
  <FinalCTA/>
  </>; }
