...
export function Footer() {
  ...
  </div><div className="footer-bottom container"><p><span className="footer-credit-desktop">Copyright © {new Date().getFullYear()} Sun Direct Renewable Inc. All rights reserved. </span><span className="footer-credit-mobile">© {new Date().getFullYear()} Sun Direct Renewable Inc. | All rights reserved. </span><span className="footer-credit-by">Website by <a href="https://vantexwebstudio.com" target="_blank" rel="noreferrer">VantexWeb</a></span></p></div></footer>;
}
