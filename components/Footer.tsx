...
export function Footer() {
  ...
  </div><div className="footer-bottom container"><p>&copy; {new Date().getFullYear()} Sun Direct Renewable Inc. All rights reserved. Proudly serving Alberta with solar solutions for homes, businesses and farms.</p></div></footer>;
}
