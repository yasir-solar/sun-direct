...
export function Footer() {
  return <footer className="footer"><div className="footer-rays" aria-hidden="true"/><div className="footer-top container">
    <div className="footer-brand"><Link href="/" className="logo" aria-label="Sun Direct Renewable home"><span className="logo-image" aria-hidden="true"><Image src="/media/brand/sun-direct-renewable-logo.png" alt="" width={1822} height={863} /></span></Link><p>Sun Direct Renewable designs solar solutions for Alberta homes, businesses and farms. We guide customers from electricity-usage analysis through design, approvals, installation and system activation.</p><span className="location-pill">Calgary, Alberta</span></div>
    ...
    <div><h2>Resources</h2><Link href="/how-solar-works">How Solar Works</Link><Link href="/solar-incentives-financing">Incentives & Financing</Link><Link href="/faq">FAQ</Link><Link href="/blog">Blog</Link><Link href="/service-areas">Service Areas</Link><a href="https://solarclub.ca" target="_blank" rel="noopener noreferrer">Solar Club</a><a href="https://solaralberta.ca" target="_blank" rel="noopener noreferrer">Solar Alberta</a></div>
