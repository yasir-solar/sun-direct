...
export function Footer() {
  return <footer className="footer footer-contact"><div className="footer-rays" aria-hidden="true"/><div className="footer-top container">
    ...
    <div className="footer-contact-details"><p className="footer-label">Contact Sun Direct</p><a className="footer-direct-contact" href="tel:+14039099440"><span>Phone</span><strong>403-909-9440</strong></a><a className="footer-direct-contact" href="https://www.google.com/maps/search/?api=1&query=303%20-%2038%20Street%20Southwest%2C%20Calgary%2C%20AB%2C%20Canada" target="_blank" rel="noreferrer"><span>Office</span><strong>303 - 38 Street Southwest<br/>Calgary, AB, Canada</strong></a><p className="footer-label footer-email-label">Email us</p><div className="footer-inbox-list">{inboxes.map(({ label, email }) => <a key={email} href={`mailto:${email}`}><span>{label}</span><strong>{email}</strong></a>)}</div></div>
